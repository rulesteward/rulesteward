...
//! logic to `tools/auditd-stig-update/src/source.rs` (generic zip-fetch, not
//! auditd-specific); kept as a separate copy so this tool has no dependency on
//! the auditd crate/tool.
