...
//! logic to `tools/auditd-stig-update/src/config.rs` (the file format is generic,
//! not fapolicyd-specific); kept as a separate copy so this tool has no dependency
//! on the auditd crate/tool.
