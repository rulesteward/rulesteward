//! Tests for au-W02 (shadow/subsumption), au-E01 (post-lock unreachable),
//! au-W03 (suppression conflict), and au-W04 (mid-stream -D) - issue #193.
//!
//! # Grounding
//!
...
//
// Content: always FIRST, never SECOND (inert).
...
//
// Content (single flat audit.rules):
//   ## This file is automatically generated from /etc/audit/rules.d
//   -D
//   -b 8192
//   -w /etc/passwd -p wa -k identity
...
//
// Legal `-C` syntax: only `=`/`!=` are valid operators (parser.rs:599-603;
