# report golden scenario: hash-none-typescope
...
A type-scoped grant (ftype) has no inline hash: hashOrigin none, hash null, hashAlgorithm null. Honest none, not a gap.
...
### rules.d/65-none-ftype.rules

```
allow perm=open all : ftype=text/x-shellscript
```
